...
async function copyIssueConfirmationToClipboard(documentNumber, issuedBy, documentTitle) {
  ...
  if (!window.isSecureContext || !navigator.clipboard || typeof navigator.clipboard.write !== "function" || typeof ClipboardItemConstructor !== "function") {
  ...
  try {
    ...
    if (error && error.name === "NotAllowedError") {
      throw new Error("Przeglądarka zablokowała schowek. Zezwól stronie na dostęp do schowka i spróbuj ponownie.");
    }
    throw new Error("Nie udało się skopiować obrazu PNG. Użyj aktualnej wersji Chrome, Edge lub Firefox przez HTTPS.");
  }
}
